...
public class UserCompanyController {
	...
	public ResponseEntity<CompanyDto> getMyCompany(@AuthenticationPrincipal UserDetails userDetails) {
		if (userDetails == null) {
			return ResponseEntity.status(401).build();
		}
		CompanyDto company = companyService.findByUserEmail(userDetails.getUsername());
		return company != null
